...
imgSlider.addEventListener("click", (event) => {
  if (event.target === product_1) {
    BigImage.setAttribute("src", "images/product1/product21.PNG");
  } else if (event.target === product_2) {
    BigImage.setAttribute("src", "images/product1/product22.PNG");
  } else {
    BigImage.setAttribute("src", "images/product1/product23.PNG");
  }
});

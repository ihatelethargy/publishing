...
imgSlider.addEventListener('click', event => {
    ...
    if (event.target === product_1) {
         BigImage.setAttribute ("src","images/product1/product1_2_1.PNG");
    }

    else if (event.target === product_2) {
        BigImage.setAttribute ("src","images/product1/product1_2_2.PNG");
    }

    else {
    BigImage.setAttribute ("src","images/product1/product1_2_3.PNG");
    }
});

...
imgSlider.addEventListener('click', event => {
    ...
    if (event.target === product_1) {
         BigImage.setAttribute ("src","images/product4/product4_1_1.PNG");
    }

    else if (event.target === product_2) {
        BigImage.setAttribute ("src","images/product4/product4_1_2.PNG");
    }

    else {
    BigImage.setAttribute ("src","images/product4/product4_1_3.PNG");
    }
});
